...
class APIView(View):
    ...
    def as_view(cls, **initkwargs):
        ...
        # Note: session based authentication_app is explicitly CSRF validated,
        # all other authentication_app is CSRF exempt.
    ...
    def perform_authentication(self, request):
        """
        Perform authentication_app on the incoming request.

        Note that if you override this and simply 'pass', then authentication_app
